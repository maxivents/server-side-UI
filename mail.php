<?php
	$email = htmlspecialchars((string) json_decode(file_get_contents('php://input'), true)['email']);
	$massage = htmlspecialchars((string) json_decode(file_get_contents('php://input'), true)['massage']);
